	...
	-- OutputMsg( "                           Chien truong Tong - Kim - 11h (15 : 50) " );
	...
	OutputMsg( " =========================Chien truong Tong - Kim So Cap 15 : 50 khoi dong --->")
	OutputMsg( " =========================Chien truong Tong - Kim Trung Cap 15 : 50 khoi dong --->")
	OutputMsg( " =========================Chien truong Tong - Kim Cao Cap 15 : 50 khoi dong --->")
	
	zMsg2SubWorld  = "<color=yellow>Chi’n tr≠Íng TËng - Kim<color> <color=0xa9ffe0>S¨ c p, Trung c p, Cao c p Æ∑ Æ’n giÍ b∏o danh, c∏c nh©n s‹ giang hÂ nhanh ch©n tham gia Æ«u qu©n, ThÍi gian b∏o danh lµ 15 phÛt."
