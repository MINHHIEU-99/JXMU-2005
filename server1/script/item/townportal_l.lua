...
function main(nItemIdx)
	if (GetFightState() == 0 or IsDisabledUseTownP() == 1 or GetTaskTemp(200) == 1 ) or ( SubWorldIdx2ID( SubWorld ) >= 1387 and SubWorldIdx2ID( SubWorld ) <= 1395)then
		Msg2Player("<color=cyan>HiÖn t¹i b¹n kh«ng thÓ sö dông Thæ §Þa Phï ë Khu Vùc Phi ChiÕn ®Êu vµ khu vùc h¹n chÕ sö dông !");
		return 1
	end
