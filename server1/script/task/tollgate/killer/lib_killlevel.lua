...
function add_shashouling(nvalue, series)
	...
	--	AddStackItem((random(1,3)),4,417,1,1,0,0,0)
		Msg2Player("B¹n nhËn ®­îc 1 s¸t thñ lÖnh cÊp 90")
		-- tbAwardTemplet:GiveAwardByList({{szName = "R­¬ng §å Xanh", tbProp = {6,1,4907,1,1,0},nCount=5}}, format("Get %s", "R­¬ng"), 1)
		-- tbAwardTemplet:GiveAwardByListWithNoneLog({{szName = "R­¬ng May M¾n", tbProp = {6,1,4913,1,1,0},nCount=1}}, 1)
		jiefangri_award()	
	end
end
