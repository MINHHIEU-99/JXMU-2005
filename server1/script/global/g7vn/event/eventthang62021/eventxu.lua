...
szPath = "script/global/g7vn/event/"..linkevent.."/check24.log"
...
function main()
	dofile("script/global/g7vn/event/"..linkevent.."/eventxu.lua")
...
local r9 = random(1,2000)
if r9==300 then
	tbAwardTemplet:GiveAwardByList({{szName = "",tbProp={6,1,5002,1,1},nCount=1},}, "test", 1);--Hoµng Kim Thiªn Th¹ch
end;

----------------------------------------------------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------------------------------------------------
local thiep1 = random(1,480)
if thiep1 == 100 then
	tbAwardTemplet:GiveAwardByList({{szName = "",tbProp={6,1,1328,1,1},nCount=1,nExpiredTime=20201229,},}, "test", 1);--ThiÖp gi¸ng sinh 1

end

local thiep2 = random(1,800)
if thiep2 == 100 then
	tbAwardTemplet:GiveAwardByList({{szName = "",tbProp={6,1,1329,1,1},nCount=1,nExpiredTime=20201229,},}, "test", 1);--ThiÖp gi¸ng sinh 2

end
local thiep3 = random(1,343)
if thiep3 == 100 then
	tbAwardTemplet:GiveAwardByList({{szName = "",tbProp={6,1,1330,1,1},nCount=1,nExpiredTime=20201229,},}, "test", 1);--ThiÖp gi¸ng sinh 3

end
local thiep4 = random(1,800)
if thiep4 == 100 then
	tbAwardTemplet:GiveAwardByList({{szName = "",tbProp={6,1,1331,1,1},nCount=1,nExpiredTime=20201229,},}, "test", 1);--ThiÖp gi¸ng sinh 4

end
local thiep5 = random(1,600)
if thiep5 == 100 then
	tbAwardTemplet:GiveAwardByList({{szName = "",tbProp={6,1,1332,1,1},nCount=1,nExpiredTime=20201229,},}, "test", 1);--ThiÖp gi¸ng sinh 5
...
local cuccl4 = random(1,1200)
if cuccl4 == 100 then
	tbAwardTemplet:GiveAwardByList({{szName = "",tbProp={6,1,1674,1,1},nCount=1,nExpiredTime=30*24*60,},}, "test", 1);--B¸ch niªn thÊt tinh th¶o
...
local b = random(1,2500)
if b==20 then
	tbAwardTemplet:GiveAwardByList({{szName = "",tbProp={6,1,4906,1,1},nCount=1,},}, "test", 1);--Xu khãa
end;

local c = random(1,2500)
if c==30 then
	tbAwardTemplet:GiveAwardByList({{szName = "",tbProp={6,1,30355,1,1},nCount=1,},}, "test", 1);--Tiªn Th¶o Lé ®Æc biÖt
end;
...
local d3 = random(1,4000)
if d3==300 then
	tbAwardTemplet:GiveAwardByList({{szName = "",tbProp={6,1,4904,1,1},nCount=1,},}, "test", 1);--B¸ch LuyÖn Thµnh C­¬ng
end;
...
if q==100 then
	tbAwardTemplet:GiveAwardByList({{szName = "",tbProp={6,1,30006,1,1},nCount=1,},}, "test", 1);--Tö Ngäc
end;
...
--	tbAwardTemplet:GiveAwardByList({{szName = "",tbProp={6,1,4878,1,1},nCount=1,nExpiredTime=7*24*60},}, "test", 1);--Lang H¹o Thiªn Th¹ch
	tbAwardTemplet:GiveAwardByList({{szName = "",tbProp={6,1,30007,1,1},nCount=1},}, "test", 1);--§¹i Tinh Ngäc
end;
...
if ts1==250 then
	tbAwardTemplet:GiveAwardByList({{szName = "B¶o R­¬ng Tinh S­¬n Liªn MAX",tbProp={6,1,4967,1,0,0},nCount=1,tbParam={1,0,0,0,0,0},},}, "test", 1);
end;

local ts2 = random(1,12000)
if ts2==250 then
	tbAwardTemplet:GiveAwardByList({{szName = "B¶o R­¬ng Tinh S­¬n Kh«i MAX",tbProp={6,1,4968,1,0,0},nCount=1,tbParam={2,0,0,0,0,0},},}, "test", 1);
end;

local ts8= random(1,12000)
if ts8==250 then
	tbAwardTemplet:GiveAwardByList({{szName = "B¶o R­¬ng Tinh S­¬n Th­îng Giíi MAX",tbProp={6,1,4969,1,0,0},nCount=1,tbParam={3,0,0,0,0,0},},}, "test", 1);
end;

local ts3 = random(1,12000)
if ts3==250 then
	tbAwardTemplet:GiveAwardByList({{szName = "B¶o R­¬ng Tinh S­¬n UyÓn MAX",tbProp={6,1,4970,1,0,0},nCount=1,tbParam={4,0,0,0,0,0},},}, "test", 1);
end;

local ts4 = random(1,12000)
if ts4==250 then
	tbAwardTemplet:GiveAwardByList({{szName = "B¶o R­¬ng Tinh S­¬n Yªu §¸i MAX",tbProp={6,1,4971,1,0,0},nCount=1,tbParam={5,0,0,0,0,0},},}, "test", 1);
end;

local ts5 = random(1,12000)
if ts5==250 then
 tbAwardTemplet:GiveAwardByList({{szName = "B¶o R­¬ng Tinh S­¬n Hµi MAX",tbProp={6,1,4974,1,0,0},nCount=1,tbParam={8,0,0,0,0,0},},}, "test", 1);
end;

local ts6 = random(1,12000)
if ts6==250 then
	tbAwardTemplet:GiveAwardByList({{szName = "B¶o R­¬ng Tinh S­¬n Béi MAX",tbProp={6,1,4975,1,0,0},nCount=1,tbParam={9,0,0,0,0,0},},}, "test", 1);
end;

local ts7= random(12000)
if ts7==250 then
	tbAwardTemplet:GiveAwardByList({{szName = "B¶o R­¬ng Tinh S­¬ng H¹ Giíi MAX",tbProp={6,1,4976,1,0,0},nCount=1,tbParam={10,0,0,0,0,0},},}, "test", 1);
...
if mn8==600 then
	tbAwardTemplet:GiveAwardByList({{szName = "M¶nh Ngùa Siªu Quang",tbProp={4,1505,1,1,0},nCount=1},}, "test", 1);	
end;
