...
function main()
	dofile("script/global/g7vn/event/3004/huanchuongchienthang.lua")
...
function XepHangTop10All()
	
	local Point = GetTask(4995)
	
	Ladder_NewLadder(10267, GetName(),Point);
		
end

function XepHangTop11All()
