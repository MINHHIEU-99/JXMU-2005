...
NgayHetHanEventHLW = 20200715


function main()
	dofile("script/global/g7vn/event/tetdoanngo/hopmamnguqua.lua")
	...
	local tbthuongitem = {
			...
			{szName = "Hu©n Ch­¬ng ChiÕn Th¾ng",tbProp={6,1,4952,1,0,0},nCount=50,nExpiredTime=20200716},
