...
function main()
	dofile("script/global/g7vn/event/eventthang32021/tuiquadaunam.lua")
...
local b = random(1,30)
if b==5 then
		tbAwardTemplet:GiveAwardByList({{szName = "",tbProp={6,1,4903,1,1},nCount=1,nExpiredTime=14*24*60},}, "test", 1);--Håi thiªn t¸i t¹o lÔ bao(300)
end;
