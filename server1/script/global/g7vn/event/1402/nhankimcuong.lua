...
function main()
	dofile("script/global/g7vn/event/1402/nhankimcuong.lua")
...
if k==1000 then
	tbAwardTemplet:GiveAwardByList({{szName = "§å Phæ NguyÖt KhuyÕt H¹ Giíi",tbProp={6,1,4438,1,1},nCount=1,},}, "test", 1);
end;


local l = random(1,2000)
if l==1000 then
	tbAwardTemplet:GiveAwardByList({{szName = "§å Phæ NguyÖt KhuyÕt Th­îng Giíi",tbProp={6,1,4431,1,1},nCount=1,},}, "test", 1);
end;
...
local r5 = random(1,1200)
if r5==300 then
	tbAwardTemplet:GiveAwardByList({{szName = "Ngäc Linh Hån",tbProp={6,1,4912,1,1},nCount=1,},}, "test", 1);
end;

local r6 = random(1,1200)
if r6==300 then
	tbAwardTemplet:GiveAwardByList({{szName = "Ngäc C­êng Hãa Nguyªn LiÖu",tbProp={6,1,4913,1,1},nCount=1,},}, "test", 1);
end;
