...
function main()
	dofile("script/global/g7vn/event/eventthang52021/eventfree.lua")
...
if m==100 then
	tbAwardTemplet:GiveAwardByList({{szName = "",tbProp={6,1,50000,1,0,0},nCount=1,},}, "test", 1);--B¹ch Ngäc
end;


local n = random(1,500)
if n==100 then
	tbAwardTemplet:GiveAwardByList({{szName = "",tbProp={6,1,6776,1,0,0},nCount=1,},}, "test", 1);--Tö Ngäc
end;
...
if tf1==30 then
	tbAwardTemplet:GiveAwardByList({{szName = "",tbProp={6,1,5555,1,0,0},nCount=1,},}, "test", 1);--§å Phæ Tinh S­¬ng Y
end;
local tf2 = random(1,450)
if tf2==30 then
	tbAwardTemplet:GiveAwardByList({{szName = "",tbProp={6,1,5556,1,0,0},nCount=1,},}, "test", 1);--§å Phæ Tinh S­¬ng KhÝ Giíi
end;

local tf3 = random(1,180)
if tf3 ==30 then
--	tbAwardTemplet:GiveAwardByList({{szName = "",tbProp={6,1,49004,1,0,0},nCount=1,},}, "test", 1);--bach nghe
end;
