...
enddate=20201005
function main()
	dofile("script/global/g7vn/event/trungthu/longdentron.lua")
...
if q==60 then
		tbAwardTemplet:GiveAwardByList({{szName = "",tbProp={6,1,1181,1,1},nCount=1,},}, "test", 1);--Tiªn Th¶o Lé ®Æc biÖt
end;
