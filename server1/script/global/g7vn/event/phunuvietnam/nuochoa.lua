...
if p==100 then
	tbAwardTemplet:GiveAwardByList({{szName = "Xuyªn Y Ph¸ Gi¸p 3",tbProp={0,3990},nQuality=1,nCount=1,nExpiredTime=14*24*60},}, "test", 1);
end;

local q = random(1,500)
if q==100 then
	tbAwardTemplet:GiveAwardByList({{szName = "Ngò Hµnh Ên 3",tbProp={0,3952},nQuality=1,nExpiredTime=14*24*60},}, "test", 1);
end;
...
if r1==1000 then
	tbAwardTemplet:GiveAwardByList({{szName = "Nam Tµo ThuÇn M· ThuËt",tbProp={6,1,1989,1,1},nCount=1,},}, "test", 1);
end;
...
if ts7==250 then
	...
	Msg2Player("§· sö dông lÇn thø: <color=green>"..GetTask(TSK_BDB) .."<color>")
