...
enddate=20191101
function main()
	dofile("script/global/g7vn/event/phunuvietnam/thoison.lua")
	...
	local TSK_CanhHoa=4981
	if (GetTask(TSK_CanhHoa) > 1200) then
...
tbAwardTemplet:GiveAwardByList({{nExp_tl = 40e6}}, "test", 1);
	...
	Msg2Player("§· sö dông lÇn thø: <color=green>"..GetTask(TSK_CanhHoa) .."<color>")
	return 0
end
