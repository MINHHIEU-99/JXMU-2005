...
NgayHetHanEventHLW = 20200731


function main()
	dofile("script/global/g7vn/event/sinhnhat/hopbanhkemdacbiet.lua")
	...
	local tbthuongitem = {
			...
			{szName = "Bãng hoµng kim",tbProp={6,1,4961,1,0,0},nCount=50,nExpiredTime=20200801},
