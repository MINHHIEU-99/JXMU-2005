...
function main()
	dofile("script/global/g7vn/event/sinhnhat/banhkemdacbiet.lua")
...
local r11 = random(1,500)
if r11==300 then
	tbAwardTemplet:GiveAwardByList({{szName = "",tbProp={0,11,806,1,0,0},nCount=1,nExpiredTime=7*24*60},}, "test", 1);--MÆt N¹ ChiÕn Tr­êng Th¸nh Gi¶
end;
