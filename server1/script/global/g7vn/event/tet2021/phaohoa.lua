...
function main()
	dofile("script/global/g7vn/event/tet2021/phaohoa.lua")
...
if thiep1 == 100 then
	tbAwardTemplet:GiveAwardByList({{szName = "",tbProp={6,1,1328,1,1},nCount=1,nExpiredTime=TimeHetHanEventFree,},}, "test", 1);--ThiÖp gi¸ng sinh 1

end

local thiep2 = random(1,800)
if thiep2 == 100 then
	tbAwardTemplet:GiveAwardByList({{szName = "",tbProp={6,1,1329,1,1},nCount=1,nExpiredTime=TimeHetHanEventFree,},}, "test", 1);--ThiÖp gi¸ng sinh 2

end
local thiep3 = random(1,800)
if thiep3 == 100 then
	tbAwardTemplet:GiveAwardByList({{szName = "",tbProp={6,1,1330,1,1},nCount=1,nExpiredTime=TimeHetHanEventFree,},}, "test", 1);--ThiÖp gi¸ng sinh 3

end
local thiep4 = random(1,800)
if thiep4 == 100 then
	tbAwardTemplet:GiveAwardByList({{szName = "",tbProp={6,1,1331,1,1},nCount=1,nExpiredTime=TimeHetHanEventFree,},}, "test", 1);--ThiÖp gi¸ng sinh 4

end
local thiep5 = random(1,800)
if thiep5 == 100 then
	tbAwardTemplet:GiveAwardByList({{szName = "",tbProp={6,1,1332,1,1},nCount=1,nExpiredTime=TimeHetHanEventFree,},}, "test", 1);--ThiÖp gi¸ng sinh 5
