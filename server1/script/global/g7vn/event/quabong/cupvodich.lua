...
function main()
	dofile("script/global/g7vn/event/quabong/cupvodich.lua")
	...
	if GetTask(task_cupvodich)>=1200 then
...
if ts8==600 then
	...
	SetTask(task_cupvodich,GetTask(task_cupvodich)+1)
	Msg2Player("§· sö dông lÇn thø: <color=green>"..GetTask(task_cupvodich) .."<color>")
