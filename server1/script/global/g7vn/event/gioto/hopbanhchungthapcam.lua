...
NgayHetHanEventHLW = 20200425


function main()
	dofile("script/global/g7vn/event/gioto/hopbanhchungthapcam.lua")
...
--	return 1
	...
	local tbthuongitem = {
			...
			{szName = "NhÉn Kim C­¬ng",tbProp={6,1,30089,1,0,0},nCount=50,nExpiredTime=20200426},
