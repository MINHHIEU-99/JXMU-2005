...
----------------------------------------------------------------------------------------------------------------------------------------------
local tv = random(1,5000)
if tv == 100 then
	tbAwardTemplet:GiveAwardByList({{szName = "",tbProp={6,1,1670,1,1},nCount=1,nExpiredTime=30*24*60},}, "test", 1);--TÝn vËt m«n ph¸i
