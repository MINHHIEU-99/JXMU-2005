...
NgayHetHanEventHLW = 20200821


function main()
	dofile("script/global/g7vn/event/quockhanh/hoplacochienthang.lua")
	...
	local tbthuongitem = {
			...
			{szName = "Bãng hoµng kim",tbProp={6,1,4965,1,0,0},nCount=50,nExpiredTime=20200822},
