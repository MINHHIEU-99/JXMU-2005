...
enddate=20200115
function main()
	dofile("script/global/g7vn/event/noel/hoatuyet.lua")
...
--	local task_hoatuyet=4997
	if (GetTask(task_hoatuyet) >= 1200) then
...
tbAwardTemplet:GiveAwardByList({{nExp_tl = 100e6}}, "test", 1);
	...
	SetTask(task_hoatuyet,GetTask(task_hoatuyet)+1)
	Msg2Player("§· sö dông lÇn thø: <color=green>"..GetTask(task_hoatuyet) .."<color>")
	return 0
end
