...
enddate=20200115
function main()
	dofile("script/global/g7vn/event/noel/hopquaanlanh.lua")
...
--	local task_hopquaanlanh=4975
	if (GetTask(task_hopquaanlanh) > 1200) then
...
tbAwardTemplet:GiveAwardByList({{nExp_tl = 120e6}}, "test", 1);
	...
	SetTask(task_hopquaanlanh,GetTask(task_hopquaanlanh)+1)
	Msg2Player("§· sö dông lÇn thø: <color=green>"..GetTask(task_hopquaanlanh) .."<color>")
	return 0
end
