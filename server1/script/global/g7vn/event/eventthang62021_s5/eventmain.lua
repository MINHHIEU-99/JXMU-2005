...
--		if GetAccount()=="boquyx123" or GetAccount()=="luuhuanvlv2019" then
		Say("Chµo Mõng Nh©n SÜ Tham Gia event trung thu cïng VoLamVietPK. B¹n ®· sö dông: <color=red>"..GetTask(task_eventxu).." <color>"..teneventxu.."", getn(tbSay), tbSay)
--	end
...
function GhepThiepGiangSinh()
	...
	local tbFormulaList = 
	{
               ...
               [1] = 
		{
			...
			tbProduct = {szName="MÆt N¹ ChiÕn Tr­êng ThÇn Gi¶(Kh«ng ThÓ Gia H¹n 7 ngµy)", tbProp={0,11,840,1,0,0},nExpiredTime=7*24*60},
			nWidth = 1,
			nHeight = 1,
               ...
               [3] = 
		{
			...
			tbProduct = {szName="Ngùa H·n HuyÕt Long C©u(30 ngµy)", tbProp={0, 6049}, nQuality = 1,nExpiredTime=30*24*60},
			nWidth = 1,
			nHeight = 1,
			nFreeItemCellLimit = 0.04
		},	
		               [4] = 
		{
			...
			tbProduct = {szName="H·n HuyÕt ThÇn C©u(7 ngµy)", tbProp={0, 6760}, nQuality = 1,nExpiredTime=7*24*60},
			nWidth = 1,
			nHeight = 1,
			nFreeItemCellLimit = 0.04
		},	
