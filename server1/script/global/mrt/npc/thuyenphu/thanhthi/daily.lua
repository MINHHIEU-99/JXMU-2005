...
function main(sel)
	...
	if (GetLevel() >= 50) and CauCa == 1 then
		Say("S«ng Hoµng Hµ uèn l­în chÝn khóc cong, em ë vïng biÓn anh trªn nói, c¸ch nhau Th­¬ng S¬n NhÜ H¶i, muèn gÆp còng kh«ng ®­îc.", 4,"§­a ta ®Õn ®Þa ®iÓm c©u c¸/dendiadiemcauca", "Ngåi thuyÒn/WharfFun", "Kh«ng ngåi/OnCancel", "§i §µo Hoa ®¶o (5) /go_thd")
	end
end;
