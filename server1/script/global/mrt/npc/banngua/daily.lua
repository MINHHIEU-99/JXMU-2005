...
elseif TatNPCBanNguaAllThanh == 1 and ScriptBanNgua == 1 then
	...
	Say("KÎ hµnh tÈu giang hå ®Òu cÇn ph¶i cã mét con ngùa chiÕn, con ngùa cña ta tuy kh«ng ph¶i næi tiÕng nh­ng søc chÞu ®ùng cña nã thËt kinh ng­êi, tÝnh nã l¹i «n hoµ, mµ gi¸ tiÒn còng kh«ng ®¾t l¾m.", 2, "Giao dÞch/yes", "Kh«ng giao dÞch/no")
end
end
