...
TIEJIANG_DIALOG = "<dec><npc>Muèn mua lo¹i binh khÝ nµo? T¹i ®©y rÊt næi tiÕng vÒ vò khÝ, kh«ng tin ng­¬i ®i hái thanh danh cña Long TuyÒn Hoµng Gia thö xem!"
...
elseif TatNPCThoRenAllThanh == 1 and ScriptMuaTBThoRen == 1 then
	...
	if(UTask_world19 == 2) then
		if (HaveItem(229) == 1) then
			tiejiang_village("<dec><npc>C©y ®ao nµy h­ háng nÆng nÒ, ph¶i bá kh«ng Ýt tiÒn ®Ó s öa nã. TiÒn tu söa 120 ng©n l­îng.", "§­a tiÒn söa ®ao/W19_repair")
		else
