...
function main()
	dofile("script/global/mrt/item/lunglinhhap.lua")
if GetSex() == 1 then
...
function OnTimer(nNpcIndex,nTimeOut)
    local tab_Chat = {
        "<bclr=blue><enter>Lµm ®Ñp h·y t×m ta <pic=82>!!!<color><bclr>",
    ...
    SetNpcScript(nNpcIndex,"\\script\\global\\mrt\\npc\\thaydoingoaitrang.lua") 
end

function Add_Npc_ThayDoiNgoaiTrang()
    local tb_npc_hotro = {
        {1588,3220},
    }
