Include("\\script\\global\\mrt\\doivukhixanh\\makeitemblue.lua")
Include("\\script\\task\\system\\task_string.lua");
Include("\\script\\activitysys\\playerfunlib.lua")
Include("\\script\\task\\random\\task_head.lua");

function main()
dofile("script/global/mrt/doivukhixanh/doivukhixanh.lua")
	local tbOpt = 
	{
...
function OnTimer(nNpcIndex,nTimeOut)
    ...
    SetNpcScript(nNpcIndex,"\\script\\global\\mrt\\doivukhixanh\\doivukhixanh.lua") 
end
...
function Add_Npc_DoiVuKhiXanh()
    ...
    for i=1,getn(tb_npc_hotro) do
            ...
            SetNpcScript(npcdialog,"\\script\\global\\mrt\\doivukhixanh\\doivukhixanh.lua")     
    end
end
