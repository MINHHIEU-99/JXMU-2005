...
Include("\\script\\global\\mrt\\thunghiem\\huyenthietlebao.lua");
Include("\\script\\global\\mrt\\thunghiem\\khongtuoclebao.lua");
Include("\\script\\global\\mrt\\thunghiem\\matnganlebao.lua");
Include("\\script\\global\\mrt\\thunghiem\\phudunglebao.lua");
Include("\\script\\global\\mrt\\thunghiem\\chusalebao.lua");
Include("\\script\\global\\mrt\\thunghiem\\chungnhulebao.lua");
TAB_OPTION = {
	["Vò khÝ"] = {
		["KiÕm"] 			= {0,0,0},
		["§ao"] 				= {0,0,1},
