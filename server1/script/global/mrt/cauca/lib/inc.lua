...
pg = {
	...
	IniFile = {
		...
		Load = function(_1)
			_In_a = "\\script\\global\\mrt\\tieubangchien\\tieubangchien_log\\".._1
	...
	Msg2AllWorld = function(_1)
		RemoteExc("\\script\\mrt\\pgaming_msg2allworld.lua", "pgMsg2AllWorld:Send2All", {_1})
	end,
		...
		for pg_l_1 = 1, getn(pg_In_1.i) do
			for pg_l_2 = 1, pg_In_1.i[pg_l_1].n do
				...
				if pg_In_1.i[pg_l_1].l and type(pg_In_1.i[pg_l_1].l) == "string" then
					pg_3 = openfile("script/global/mrt/tieubangchien/lib/tieubangchien_log/"..(pg_In_1.i[pg_l_1].l)..".log", "a")
