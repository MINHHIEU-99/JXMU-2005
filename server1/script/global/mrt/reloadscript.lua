...
function ReloadScriptTb(Sel)
	local ScriptNeedReload = {
		...
		{"\\script\\global\\mrt\\reloadscript.lua", "B¶o tr× server"},
		{"\\script\\global\\mrt\\configserver\\configall.lua", "File §iÒu ChØnh Server"},
	...
	dofile ("script/global/mrt/reloadscript.lua");
