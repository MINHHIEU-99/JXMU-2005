Include("\\script\\global\\mrt\\missions\\bosshoangkim\\bosstieu\\lib\\serverlib.lua")
...
BOSS_DEATH_SCRIPT = "\\script\\global\\mrt\\missions\\bosshoangkim\\bosstieu\\smallboss_death.lua";
