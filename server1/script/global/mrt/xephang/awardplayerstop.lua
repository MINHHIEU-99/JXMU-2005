...
Include("\\script\\global\\mrt\\xephang\\xephang_log\\awardplayertop_tb.lua")
...
function UpdateTOPPlayerPrivWeek()
	local OpenFileTopWrite = openfile("script/global/mrt/xephang/xephang_log/awardplayertop_tb.lua", "w")
	...
	LoadScript("\\script\\global\\mrt\\xephang\\xephang_log\\awardplayertop_tb.lua")
