...
WorldRank = {
	...
	FileRankSorted = "script/global/mrt/xephang/xephang_log/worldrank_sorted.lua",
	FileRankSortedTbFileLoad = "\\script\\global\\mrt\\xephang\\xephang_log\\worldrank_sorted.lua",
}
...
function WorldRank:UpdateRankData()
	...
	dofile("script/global/mrt/xephang/worldrank.lua")
