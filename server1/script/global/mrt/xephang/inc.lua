...
TBX = {
	...
	IniFile = {
		...
		Load = function(_1)
			_In_a = "\\script\\global\\mrt\\xephang\\xephang_log\\".._1
	...
	Msg2AllWorld = function(_1)
		RemoteExc("\\script\\mrt\\tinhnang\\mrt\\tinhnang_msg2allworld.lua", "TBXMsg2AllWorld:Send2All", {_1})
	end,
		...
		for TBX_l_1 = 1, getn(TBX_In_1.i) do
			for TBX_l_2 = 1, TBX_In_1.i[TBX_l_1].n do
				...
				if TBX_In_1.i[TBX_l_1].l and type(TBX_In_1.i[TBX_l_1].l) == "string" then
					TBX_3 = openfile("script/global/mrt/xephang/xephang_log/"..(TBX_In_1.i[TBX_l_1].l)..".log", "a")
