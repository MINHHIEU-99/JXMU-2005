...
--if (figure == TONG_MASTER) and GetCamp() ~= 0 and nTongID ~= 0 then
	...
	tinsert(bilTbOp, "Chøc N¨ng Live CT/MapCTC")
...
function MapCTC()
	Say("ThÇn hµnh phï cã thÓ ®­a ®¹i hiÖp <color=yellow>"..GetName().."<color> ®Õn bÊt cø thµnh thÞ hay th«n trÊn nµo, vui lßng chän n¬i ngµi muèn ®Õn.", 8, 
		"ChiÕn tr­êng biÖn kinh/MapBK",
		"ChiÕn tr­êng l©m an/MapLA",
		"ChiÕn tr­êng ph­îng t­êng/MapPT",
		"ChiÕn tr­êng t­¬ng d­¬ng/MapTD",
		"ChiÕn tr­êng thµnh ®«/MapTDo",
		"ChiÕn tr­êng d­¬ng ch©u/MapDC",
		"ChiÕn tr­êng ®¹i lý/MapDL",
		"Rêi khái/no"
		);
end
function MapBK()
