...
local tbItem = 
{
	["6,1,4528"] = {szName="Ngò Hoa Ngäc Lé Hoµn", tbProp={1,2,0,5,0,0,0},nBindState=-2},
}
...
function huitianjinlang_getpotion(nPickCount)
	...
	if IsMyItem(nItemIndex) == 1 then
		...
		if tbAwardTemplet:GiveAwardByList(%tbItem[szItemId], "Bao D­îc Hoµn") == 1 then
...
function GetDesc(nItemIndex)
	...
	return format("Cßn d­:  <color=yellow>%d<color>",(200 - nCount))
end