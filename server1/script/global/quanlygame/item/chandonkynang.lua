...
dofile("script/global/quanlygame/item/chandonkynang.lua")
...
function upgrade_skilllevel(n_skillid)
	...
	local skillhientai = HaveMagic(n_skillid)
	if (ConsumeItem(3, 1, 6, 1, 4546, -1) == 1) then
		AddMagic(n_skillid, skillhientai+1);
