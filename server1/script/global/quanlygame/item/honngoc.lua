...
function main(nItemIndex)
	...
	PlayerFunLib:AddSkillState(1509,1,3,3240,1)
	Msg2Player(format("B¹n ®· sö dông 1 viªn <color=yellow>%s<color>, Kh¸ng TÊt C¶ t¨ng thªm 10%% néi trong 3 phót sÏ tù mÊt. (khi chÕt kh«ng mÊt hiÖu øng nµy)",GetItemName(nItemIndex)));
