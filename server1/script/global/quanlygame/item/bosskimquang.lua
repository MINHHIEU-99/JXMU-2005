...
{
	586,587,588,589,590,591,592,593,594,595,596,597,598,599,600,601,602,603,604,53,999
}
...
function main(nItemIdx)
    dofile("script/global/quanlygame/item/bosskimquang.lua");
	...
	local GoldenBoss = 
	{
					 ...
					 -- {565, "§oan Méc DuÖ ", 3,12},
					  ...
					  {1475, "Kim Quang T­íng Qu©n", 0,10},
	...
	for k = 1, j do
		...
		SetNpcDeathScript(npcindex, "\\script\\missions\\boss\\bossdeathkimquang.lua");
