...
--if GetAccount()  == "" or GetAccount() =="xuanhong95" or GetAccount() ==""   then
--		tinsert(tbOpt, 1, {"tets even cua ml", Mknb}) 
--		tinsert(tbOpt, 1, {"NhËn KNB", knb}) 	
--		tinsert(tbOpt, 1, {"ADM Move=>CTC...", vitri_congthanh}) 
--		tinsert(tbOpt, 2, {"Thay §æi Tr¹ng Th¸i", trangthai}) 

--end
--if GetAccount()  == "lz" or GetAccount() =="zet111" or GetAccount() =="anhbon00" then
--		tinsert(tbOpt, 1, {"NhËn L­¬ng Bang TuÇn I", Mluong}) 
--end
