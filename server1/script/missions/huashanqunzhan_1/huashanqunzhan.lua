...
--		SetFightState(1);
	...
	--AddSkillState(963, 1, 0, 18*30) 
	TM_SetTimer(330 * 18,127,1,0);
	--AddSkillState(464, 30, 0, 18*40);
--ChangeOwnFeature(0,0,1690);	
ChangeOwnFeature( 1, 3500*18, 1660,  0, 0, 0, 0)
--tbAwardTemplet:GiveAwardByList({{szName="anh hïng lÖnh",tbProp={6,1,4565,1,0,0,0},nCount=1},}, "test", 1);
...
function huashanqunzhan:Judge(tbPlayer)
	...
	local szMsg = format("<color=pink>B¹n lµ ng­êi chiÕn th¾ng cuèi cïng, trong vßng <color=yellow>%d<color> phót ph¶i ®Õn Qu©n Nhu Quan Tèng Kim ®Ó nhËn th­ëng qu¸ thêi h¹n sÏ kh«ng nhËn ®­îc n÷a.", self.nLatencyTime-nCurTime)
	ForbitSyncName(PIdx2NpcIdx(PlayerIndex), 0)
