...
SKILLS={
	...
	wudu_daofa={ --Îå¶¾µ¶·¨
		addphysicsdamage_p={{{1,20},{20,250}},{{1,-1},{20,-1}},{{1,1},{2,1}}},
	...
	wangu_shixin={ --Íò¹ÆÊ´ÐÄ
		poisontimereduce_p={{{1,-1},{20,-20}},{{1,18*45},{20,18*120}}},
	...
	wudu_qijing={ --Îå¶¾Ææ¾­
		addpoisonmagic_v={{{1,5},{30,110}},{{1,-1},{20,-1}},{{1,11},{2,11}}},
		addpoisondamage_v={{{1,5},{30,88}},{{1,-1},{20,-1}},{{1,11},{2,11}}},
		--addpoisondamage_v={{{1,5},{30,100}},{{1,-1},{20,-1}},{{1,11},{2,11}}},
	--	poisonenhance_p={{{1,12},{30,45},{33,50},{35,51},{38,54}},{{1,-1},{2,-1}}},
		poisonenhance_p={{{1,12},{30,55},{33,58},{35,59},{38,62}},{{1,-1},{2,-1}}},
		deadlystrikeenhance_p={{{1,4},{30,93}},{{1,-1},{2,-1}}},
--		castspeed_v={{{1,1},{15,15},{30,33}},{{1,-1},{2,-1}}},
--		attackspeed_v={{{1,1},{15,15},{30,33}},{{1,-1},{2,-1}}},
	...
	yinfeng_shigu={ --Òõ·çÊ´¹Ç
		...
		poisondamage_v={{{1,20},{15,50},{20,171}},{{1,60},{20,60}},{{1,10},{20,10}}},
		...
		skill_skillexp_v={{	{1,SkillExpFunc(100,1.15,1,1,5)},
							{2,SkillExpFunc(100,1.15,2,1,5)},
							{3,SkillExpFunc(100,1.16,3,1,5)},
							{4,SkillExpFunc(100,1.17,4,1,5)},
							{5,SkillExpFunc(100,1.18,5,1,5)},
							{6,SkillExpFunc(100,1.19,6,1,5)},
							{7,SkillExpFunc(100,1.20,7,1,5)},
							{8,SkillExpFunc(100,1.21,8,1,5)},
							{9,SkillExpFunc(100,1.22,9,1,5)},
							{10,SkillExpFunc(100,1.23,10,1,5)},
							{11,SkillExpFunc(100,1.24,11,1,5)},
							{12,SkillExpFunc(100,1.23,12,1,5)},
							{13,SkillExpFunc(100,1.22,13,1,5)},
							{14,SkillExpFunc(100,1.21,14,1,5)},
							{15,SkillExpFunc(100,1.20,15,1,5)},
							{16,SkillExpFunc(100,1.19,16,1,5)},
							{17,SkillExpFunc(100,1.18,17,1,5)},
							{18,SkillExpFunc(100,1.17,18,1,5)},
							{19,SkillExpFunc(100,1.16,19,1,5)},
							{20,SkillExpFunc(100,1.15,20,1,5)},
							}},
	},
	zhuifeng_duji={ --×··ç¶¾¼¬
	...
	tiangang_dushou={ --Ììî¸¶¾ÊÖ
		seriesdamage_p={{{1,20},{20,60},{21,62}}},
		poisondamage_v={{{1,1},{20,30}},{{1,80},{20,60}},{{1,10},{20,10}}},
	},
	xuanyin_zhan={ --ÐþÒõÕ¶
		seriesdamage_p={{{1,20},{15,20},{20,60},{21,62}}},
		physicsenhance_p={{{1,15},{15,80},{20,200}}},
		deadlystrikeenhance_p={{{1,2},{20,50}},{{1,-1},{2,-1}}},

		poisondamage_v={{{1,20},{15,30},{20,80}},{{1,60},{20,60}},{{1,10},{20,10}}},
		--poisondamage_v={{{1,20},{15,60},{20,120}},{{1,60},{20,60}},{{1,10},{20,10}}},
		missle_speed_v={{{1,28},{20,32},{21,32}}},
		skill_attackradius={{{1,448},{20,512},{21,512}}},
		skill_cost_v={{{1,30},{20,60}}},
		addskillexp1={{{1,0},{2,0}},{{1,1},{20,1}},{{1,0},{2,0}}},
		skill_skillexp_v={{	{1,SkillExpFunc(100,1.15,1,1,3)},
							{2,SkillExpFunc(100,1.15,2,1,3)},
							{3,SkillExpFunc(100,1.16,3,1,3)},
							{4,SkillExpFunc(100,1.17,4,1,3)},
							{5,SkillExpFunc(100,1.18,5,1,3)},
							{6,SkillExpFunc(100,1.19,6,1,3)},
							{7,SkillExpFunc(100,1.20,7,1,3)},
							{8,SkillExpFunc(100,1.21,8,1,3)},
							{9,SkillExpFunc(100,1.22,9,1,3)},
							{10,SkillExpFunc(100,1.23,10,1,3)},
							{11,SkillExpFunc(100,1.24,11,1,3)},
							{12,SkillExpFunc(100,1.23,12,1,3)},
							{13,SkillExpFunc(100,1.22,13,1,3)},
							{14,SkillExpFunc(100,1.21,14,1,3)},
							{15,SkillExpFunc(100,1.20,15,1,3)},
							{16,SkillExpFunc(100,1.19,16,1,3)},
							{17,SkillExpFunc(100,1.18,17,1,3)},
							{18,SkillExpFunc(100,1.17,18,1,3)},
							{19,SkillExpFunc(100,1.16,19,1,3)},
							{20,SkillExpFunc(100,1.15,20,1,3)},
							}},
		addskilldamage1={
			[1]={{1,1067},{2,1067}},
			[3]={{1,1},{20,32}}
