...
add_ai2()
Msg2MSAll(73,"<color=green>§éi tr­ëng ®¸m ph¶n ®å Thiªn V­¬ng ®· bÞ tiªu ®iÖt h·y tiÕn vÒ phÝa tr­íc nµo. <color>")
...
tbDropTemplet:GiveAwardByList(nNpcIndex, -1, tbItem,TitleStr, 1)
	...
	for i=1,nCount do
		doFunByPlayer(tbRoundPlayer[i], PlayerFunLib.AddExp, PlayerFunLib, 1000000, 0, format("%s phÇn th­ëng","Kinh nghiÖm ®øng gÇn lóc §éc C« CÇu B¹i bÞ tiªu diÖt"));
	end
end
