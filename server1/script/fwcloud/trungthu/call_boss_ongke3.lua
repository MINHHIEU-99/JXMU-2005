...
function AddOngTuyet3()
	IDBoss = {1234,1235}
	local AddIDBoss = IDBoss[random(1,2)]
	local mapidx = SubWorldID2Idx(176)
	local npcindex = AddNpcEx(AddIDBoss, 95, random(0,4), mapidx, 1651*32, 2863*32, 1, "Tuy’t Nhi", 1) -- lam an
       local npcindex1 = AddNpcEx(AddIDBoss, 95, random(0,4), mapidx, 1651*32, 2863*32, 1, "Tuy’t Nhi", 1)
       local npcindex2 = AddNpcEx(AddIDBoss, 95, random(0,4), mapidx,  1651*32, 2863*32, 1, "Tuy’t Nhi", 1)
       local npcindex3 = AddNpcEx(AddIDBoss, 95, random(0,4), mapidx, 1651*32, 2863*32, 1, "Tuy’t Nhi", 1)
