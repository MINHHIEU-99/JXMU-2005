				...
				tbFormula = 
					{
						...
						tbProduct = {szName = "H¹t Mµu S¾c", tbProp = {6,1,30100,1,0,0}, nExpiredTime=20240314},
					},
					pCompos = nil;
			},
				...
				tbFormula = 
					{
						...
						tbProduct = {szName = "Bã Hoa Hång", tbProp = {6,1,30102,1,0,0}, nExpiredTime=20240314},
					},
					pCompos = nil;
			},
		["TÆng Bã Hoa Hång"] = 
									...
									[1]=
										{
											...
											{szName="Hoa Hång",tbProp={6,1,30097,1,0,0},nCount=2,nExpiredTime=20240314},											
										},
									nRate = 50,
								},
								[2]={
									[1]=
										{
											...
											{szName="Hoa Hång",tbProp={6,1,30097,1,0,0},nCount=1,nExpiredTime=20240314},
										},
									nRate = 50,
								},
							},
				...
				tbFormula = 
					{
						...
						tbProduct = {szName = "D©y Cét Hoa", tbProp = {6,1,30098,1,0,0}, nExpiredTime=20240314},
					},
					pCompos = nil;
			},
	}
