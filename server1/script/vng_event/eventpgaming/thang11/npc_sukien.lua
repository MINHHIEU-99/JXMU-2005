...
dofile("script/vng_event/eventpgaming/thang11/npc_sukien.lua")
	...
	tbDailog.szTitleMsg = "<npc><color=green>Ng≠¨i c„ muËn lµm B› Ki’p Gia Truy“n kh´ng<color>",
...
local nDayNow = "20"..nYMD..""
	if (nDayNow >= nTime1) and (nDayNow <= nTime2) then
		...
		Talk(1,"","<color=green>Hoπt ßÈng Di‘n Ra Tı:\n\n <color=red>0h Ngµy 01 - 11 - 20"..nYear.." ß’n 0h Ngµy 01 - 12 - 20"..nYear.."<color><color>")
	end
end				
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function NhanMoc()
	local tbOpt = {
		{"NhÀn Th≠Îng MËc "..nGioiHanMoc1.." B› Ki’p Gia Truy“n",PhanThuong1},
		{"NhÀn Th≠Îng MËc "..nGioiHanMoc2.." B› Ki’p Gia Truy“n",PhanThuong2},
		{"NhÀn Th≠Îng MËc "..nGioiHanMoc3.." B› Ki’p Gia Truy“n",PhanThuong3},
		{"HÒy B·",},
	}
	CreateNewSayEx("<npc><color=green>"..myplayersex().." MuËn NhÀn MËc Nµo<color>\n<color=red>Hi÷n Tπi Ng≠¨i ß∑ Sˆ DÙng <color=yellow>"..GetTask(BIKIEP).."<color> B› Ki’p Gia Truy“n<color>", tbOpt)
end	
-----------------------------------------------------Moc 500-------------------------------------------------------------------------------------------------------------------------------------------
