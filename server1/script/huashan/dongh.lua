...
function main()
	...
	elseif ( Uworld1226 == 0 ) then 
		Describe(DescLink_JianHuangDiZi..": Th»ng FA nµy muèn g× nµo ?",2, 
		"Ta Fa ®· l©u, nay muèn cã thªm ng­êi huynh ®Ö/partner_givetodo", 
...
function partner_givetodo()                                --Ìá¹©Ò»¸öÍ¬°é
	...
	elseif ( partnercount == 5 ) then
		...
		Describe(DescLink_JianHuangDiZi.." NÕu mµ ng­¬i ®· FA l©u n¨m nh­ thÕ th× ta gióp dc, lùa chän 1 ng­êi huynh ®Ö ®i nµo !",6, 
