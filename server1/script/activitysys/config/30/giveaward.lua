...
tbItem = {
	[1]={szName="C﹜ B髏",tbProp={6,1,3040,1,0,0},nExpiredTime=EventNhaGiaoVN2011.ItemExpiredTime},
}

tbBaizhi = {
	[1]={szName="Gi蕐 Tr緉g",tbProp={6,1,3039,1,0,0},nExpiredTime=EventNhaGiaoVN2011.ItemExpiredTime,nRate=5,}, 
}
