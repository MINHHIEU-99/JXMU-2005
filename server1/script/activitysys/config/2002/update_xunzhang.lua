...
tbMaterial_Medal = {
	[1]={szName="Ph¸o TiÓu",tbProp={6,1,1351,1,0,0},nExpiredTime=nTime,nCount=3,},
	[2]={szName="Ph¸o Trung",tbProp={6,1,1352,1,0,0},nExpiredTime=nTime,nCount=3,},
	}
tbProduct = {
	[1] = {szName="Ph¸o Trung",tbProp={6,1,1352,1,0,0},nExpiredTime=nTime,},
	[2] = {szName="Ph¸o §¹i",tbProp={6,1,1353,1,0,0},nExpiredTime=nTime,}
	}
...
function pActivity:InitUpdateCompose()
	...
	for nType=1,getn(%tbMaterial_Medal) do
		...
		tbFormulaList.nRate = %TyLePhaoTrungPhaoDai[nType]
