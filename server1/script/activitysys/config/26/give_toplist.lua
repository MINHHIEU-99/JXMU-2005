...
function tbTop10:GiveItem(strName, strAccount, nCount)
	...
	if nPhase ~= 1 then
		Msg2Player("HiÖn T¹i Kh«ng Ph¶i Thêi Gian §ua TOP Kh«ng ThÓ Sö Dông VËt PhÈm")
		return
	end
...
function tbTop10:ShowTopList()
	...
	local strTittle = "<color=fire>Danh S¸ch 10 Ng­êi Cã Sè L­îng Nép NhiÒu NhÊt<color>\n"
