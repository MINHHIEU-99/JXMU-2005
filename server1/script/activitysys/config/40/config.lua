...
tbConfig[1] = --Ò»¸öÏ¸½Ú
{
	...
	nStartDate = EventGhepHoaHong.StartDate,
	nEndDate  = EventGhepHoaHong.EndDate,
	tbMessageParam = {nil},
	tbCondition = 
	{
	},
...
tbConfig[3] = --Ò»¸öÏ¸½Ú
{
	...
	tbActition = 
	{
		{"PlayerFunLib:GetItem",	{ITEM_LUCY_BELT,30,EVENT_LOG_TITLE,"TongKim3000"} },
	},
}
tbConfig[4] = --Ò»¸öÏ¸½Ú
{
	...
	tbActition = 
	{
		{"PlayerFunLib:GetItem",	{ITEM_LUCY_BELT,10,EVENT_LOG_TITLE,"TongKim1000"} },
	},
}
tbConfig[5] = --Ò»¸öÏ¸½Ú
{
	...
	tbActition = 
	{
		{"PlayerFunLib:GetItem",	{ITEM_LUCY_BELT,10,EVENT_LOG_TITLE,"VuotAi17"} },
	},
}
tbConfig[6] = --Ò»¸öÏ¸½Ú
{
	...
	tbActition = 
	{
		{"PlayerFunLib:GetItem",	{ITEM_LUCY_BELT,10,EVENT_LOG_TITLE,"VuotAi28"} },
	},
}
tbConfig[7] = --Ò»¸öÏ¸½Ú
{
	...
	tbActition = 
	{
		{"PlayerFunLib:GetItem",	{ITEM_LUCY_BELT,10,EVENT_LOG_TITLE,"TieuDietThuyTacDauLinh"} },
	},
}
tbConfig[8] = --Ò»¸öÏ¸½Ú
{
	...
	tbActition = 
	{
		{"PlayerFunLib:GetItem",	{ITEM_LUCY_BELT,20,EVENT_LOG_TITLE,"TieuDietThuyTacDaiDauLinh"} },
	},
}
tbConfig[9] = --Ò»¸öÏ¸½Ú
{
	...
	tbActition = 
	{
		{"PlayerFunLib:GetItem",	{ITEM_LUCY_BELT,15,EVENT_LOG_TITLE,"VuotAiViemDe10"} },
	},
}
tbConfig[10] = --Ò»¸öÏ¸½Ú
{
	...
	tbActition = 
	{
		{"PlayerFunLib:GetItem",	{ITEM_LUCY_BELT,30,EVENT_LOG_TITLE,"TieuDietBossTheGioi"} },
	},
}
tbConfig[11] = --Ò»¸öÏ¸½Ú
{
	...
	tbActition = 
	{
		{"PlayerFunLib:GetItem",	{ITEM_LUCY_BELT,3,EVENT_LOG_TITLE,"TieuDietBossSatThu"} },
	},
}
tbConfig[12] = --Ò»¸öÏ¸½Ú
{
	...
	tbActition = 
	{
		...
		{"AddDialogOpt",	{"KiÓm tra sè Hoa Hång ®· dïng",30} },
...
tbConfig[21] = --Ò»¸öÏ¸½Ú
{
	...
	tbCondition = 
	{
		...
		{"PlayerFunLib:CheckIsTransLife",	{"Relife 1 trë lªn míi cã thÓ nhËn phÇn th­ëng"} },
...
tbConfig[24] = --Ò»¸öÏ¸½Ú
{
	...
	{
		-- {"PlayerFunLib:CheckTotalLevel",	{150,"default",">="} },
		{"PlayerFunLib:CheckFreeBagCell",	{6,"default"} },
