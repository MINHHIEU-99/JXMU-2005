...
function pActivity:CheckEventCount(nNpcIndex)
	Msg2Player("<color=green>Giá Hoa Hång tam s¾c: <color><color=yellow>"..self:GetTask(%TSK_3COLOR_ROSE).."<color>"..
				"\n<color=green>Giá Hoa Hång tø s¾c: <color><color=yellow>"..self:GetTask(%TSK_4COLOR_ROSE).."<color>"..
				"\n<color=green>Giá Hoa Hång vÜnh cöu: <color><color=yellow>"..self:GetTask(%TSK_CORBEIL).."<color>"..
	"")
end 
...
function pActivity:Use3ColorRose()
	...
	local tbAward = %tbAward_Ext["3Color_Rose"]
...
function pActivity:Use4ColorRose()
	...
	local tbAward = %tbAward_Ext["4Color_Rose"]
