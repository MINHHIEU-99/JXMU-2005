...
tbMonstorAward = {
	-- [321] = {	-- ³¤°×É½ÄÏ
	-- 	[1]={szName="Hoa Hång Tr¾ng",tbProp={6,1,3117,1,0,0},nExpiredTime=20221115,nRate = 25.0,},
	-- 	[2]={szName="Hoa Hång Vµng",tbProp={6,1,3119,1,0,0},nExpiredTime=20221115,nRate = 25.0,},
	-- 	[3]={szName="Tói H­¬ng Hoa Hång",tbProp={6,1,3125,1,0,0},nExpiredTime=20221115,nRate = 10.0,},
	-- 	},	
	-- [322] = {	-- ³¤°×É½±±
	-- 	[1]={szName="Hoa Hång Xanh",tbProp={6,1,3118,1,0,0},nExpiredTime=20221115,nRate = 25.0,},
	-- 	[2]={szName="Hoa hång ®á",tbProp={6,1,3120,1,0,0},nExpiredTime=20221115,nRate = 25.0,},
	-- 	[3]={szName="Tói H­¬ng Hoa Hång",tbProp={6,1,3125,1,0,0},nExpiredTime=20221115,nRate = 10.0,},
	-- 	},
	-- [227] = {	-- É³Ä®É½¶´3
	-- 	[1]={szName="Hoa Hång Tr¾ng",tbProp={6,1,3117,1,0,0},nExpiredTime=20221115,nRate = 20.0,},
	-- 	[2]={szName="Hoa Hång Vµng",tbProp={6,1,3119,1,0,0},nExpiredTime=20221115,nRate = 20.0,},
	-- 	[3]={szName="Hoa Hång Xanh",tbProp={6,1,3118,1,0,0},nExpiredTime=20221115,nRate = 20.0,},
	-- 	},
	-- [340] = {	-- Äª¸ß¿ß
	-- 	[1]={szName="Hoa Hång Xanh",tbProp={6,1,3118,1,0,0},nExpiredTime=20221115,nRate = 20.0,},
	-- 	[2]={szName="Hoa Hång Vµng",tbProp={6,1,3119,1,0,0},nExpiredTime=20221115,nRate = 20.0,},
	-- 	[3]={szName="Hoa hång ®á",tbProp={6,1,3120,1,0,0},nExpiredTime=20221115,nRate = 20.0,},
	-- 	},
	[995] = {
		[1]={szName="Hoa Hång Xanh",tbProp={6,1,3118,1,0,0},nExpiredTime=20221115,nRate = 1,},
	 	[2]={szName="Hoa Hång Vµng",tbProp={6,1,3119,1,0,0},nExpiredTime=20221115,nRate = 1,},
	 	[3]={szName="Hoa hång ®á",tbProp={6,1,3120,1,0,0},nExpiredTime=20221115,nRate = 1,},
	 	[4]={szName="Hoa Hång Tr¾ng",tbProp={6,1,3117,1,0,0},nExpiredTime=20221115,nRate = 1,},
	},
	[996] = {
		[1]={szName="Hoa Hång Xanh",tbProp={6,1,3118,1,0,0},nExpiredTime=20221115,nRate = 1,},
	 	[2]={szName="Hoa Hång Vµng",tbProp={6,1,3119,1,0,0},nExpiredTime=20221115,nRate = 1,},
...
tbItemAward = {
	...
	["MeiGuiXiangDai"] = {
		[1]={szName="Hoa Hång Xanh",tbProp={6,1,3118,1,0,0},nCount=5, nExpiredTime=20221115,nRate = 25.0,},
		[2]={szName="Hoa Hång Vµng",tbProp={6,1,3119,1,0,0},nCount=5, nExpiredTime=20221115,nRate = 25.0,},
		[3]={szName="Hoa hång ®á",tbProp={6,1,3120,1,0,0},nCount=5, nExpiredTime=20221115,nRate = 25.0,},
		[4]={szName="Hoa Hång Tr¾ng",tbProp={6,1,3117,1,0,0},nCount=5, nExpiredTime=20221115,nRate = 25.0,},
		},		
	}	
...
tbItemOtherAward = {
	...
	["Corbeil"] = {
		...
		[16000] = {
			tbAward ={
					{szName="B¶o r­¬ng vò khÝ HKMP",tbProp={6,1,4895,1,0,0},nCount=1,CallBack = _Message},	
			...
			szLog = "SuDungGioHoaHongVinhCuu16000LanBaoRuongVKHKMP",
			},	
		},
	}	
...
-- ÐÒÔË´øµÄ½±ÀøÒÔ¼°¸ÅÂÊ	
tbLuckBeltAward = {
	[1]={szName="Bã Hång Tam S¾c",tbProp={6,1,3121,1,0,0},nExpiredTime=20221115,nBindState = -2,},
	[2]={szName="Bã Hång Tø S¾c",tbProp={6,1,3122,1,0,0},nExpiredTime=20221115,nBindState = -2,},
	[3]={szName="Giá Hoa Hång VÜnh Cöu",tbProp={6,1,3127,1,0,0},nExpiredTime=20221115,nBindState = -2,},	
	}	
tbLuckBelt = {
