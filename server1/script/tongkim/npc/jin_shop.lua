...
--§iÒu chØnh ®iÓm kinh nghiÖm giíi h¹n khi ®æi ®iÓm tİch luü -  - 20110810
--Limit_Exp = 550000
--Limit_Exp = 700000
tbLimit_Exp = {
						[0] = 700000,
...
function maintalk()
	...
	tbDailog:AddOptEntry("Dïng Nh¹c V­¬ng Hån Th¹ch ®æi lÊy LB Hoat §éng", talk_yulongtie)
	...
	tbDailog:AddOptEntry("ChiÕn tr­êng v« song m·nh t­íng",wushuangmengjiang)
	tbDailog:AddOptEntry("b¶ng b×nh phÈm xÕp h¹ng",person_change)
	tbDailog:AddOptEntry("®Æc hiÖu vßng trßn ®Æc biÖt",effect_aura)
	-- tbDailog:AddOptEntry("Ta Muèn Mua §å Phæ Hoµng Kim",goldenitem_menu)
	-- tbDailog:AddOptEntry("Ta Muèn Mua §¸ VÒ §Ëp",ore)
	
	--tbDailog:AddOptEntry("Cöa hµng tinh lùc", energy_sale);
	-- tbDailog:AddOptEntry("§æi Bİ B¶o", duihuangmibao) 
	--T¹m ®ãng kiÕm gia mª cung -  - 20110810
...
function xunzhang_exchange()
	...
	elseif ( CalcFreeItemCellCount() < 1 ) then
		...
		Say("Qu©n Nhu Quan: Ng­êi cã muèn dïng 500 ®iÓm tİch lòy ®Ó ®æi lÊy Huy ch­¬ng kh«ng?", 2,
		"§æi lÊy Huy ch­¬ng/xunzhang_do",
...
function person_change()
	Say("Qu©n Nhu quan: T¹i<color=yellow> b¶ng b×nh phÈm xÕp h¹ng <color>xÕp h¹ng<color=yellow> 5 tªn<color> ng­êi ch¬i ®Çu tiªn sÏ nhËn ®­îc danh hiÖu ®Æc biÖt vµ h×nh t­îng oai phong",
	 3, 
	 "Xem h×nh t­îng nh©n vËt nam Tèng Kim/title_male",
	 "Xem h×nh t­îng nh©n vËt n÷ Tèng Kim/title_female",
	 "Kh«ng muèn xem ®©u!/no" )
end;
...
function effect_aura()
	Say("Qu©n Nhu quan: T¹i<color=yellow> b¶ng b×nh phÈm xÕp h¹ng <color>xÕp h¹ng <color=yellow>5 tªn<color> nh©n vËt ®Çu tiªn sÏ nhËn ®­îc ®Æc hiÖu vßng trßn ®Æc biÖt", 
	6,
	 "Xem §Şnh Quèc Nguyªn So¸i §Æc HiÖu/aura_dingguo",
	 "Xem An Bang §¹i T­íng Qu©n §Æc HiÖu/aura_anbang",
	 "Xem Phiªu Kú T­íng Qu©n §Æc HiÖu/aura_biaoji",
	 "Xem Vò L©m Trung Lang §Æc HiÖu/aura_yulin",
	 "Xem Chiªu Vâ HiÖu óy §Æc HiÖu/aura_zhaowu",
	 "Kh«ng muèn xem ®©u!/no" );
end
...
function yuewang_want()
	Say("Qu©n Nhu quan: Tõ nh÷ng tinh hoa cã ®­îc trong Nh¹c V­¬ng Hån Th¹ch ta chÕ t¹o ra Nh¹c V­¬ng KiÕm, cÇn ph¶i tèn"..YUEWANGHUN_STONECOUNT.."Viªn Nh¹c V­¬ng Hån Th¹ch nµy x¸c ®Şnh ®æi ph¶i kh«ng?",
	 2,
	  "Muèn/yuewang_change",
	   "§Ó ta xem l¹i/no")
end
