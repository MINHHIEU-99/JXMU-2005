...
function wushuangmengjiang()
	Say("§Ó biÓu d­¬ng c«ng lao trong chiÕn tr­êng, nÕu nh­ trong tuÇn cã biÓu hiÖn tèt sÏ ®­îc träng th­ëng!", 5,
	 "T×m hiÓu chi tiÕt quy t¾c/getrule", 
	 "Xem b¶ng tæng kÕt xÕp h¹ng chiÕn tr­êng/getranklist",
	  "Xem b¶ng xÕp h¹ng chiÕn tr­êng hiÖn t¹i/getcurranklist",
	   "Ta muèn lÜnh th­ëng/guanghuan_sure", 
	   "ChØ ghÐ ch¬i th«i./no")
end

function getrule()
	Say("Trong vßng 1 tuÇn ®­îc top 10 sÏ ®­îc tõ 1 ®Õn 10 ®iÓm, trong mét tuÇn nÕu nh­ ®¹t ®iÓm cao nhÊt sÏ ®­îc triÒu ®×nh s¾c phong v« song m·nh t­íng vµ ban träng th­ëng!", 2,
	 "Ta muèn t×m hiÓu viÖc kh¸c/wushuangmengjiang", 
...
function guanghuan_sure()
	--[20101230]:thay doi phan thuong TKTT
...
--		get_wushuangguanghuan(nCutDownTime)
	...
	Say("ChØ cã m·nh t­íng ®¹t ®iÓm cao nhÊt trong tuÇn míi ®­îc nhËn phÇn th­ëng! Muèn nhËn phÇn th­ëng th× h·y nç lùc giÕt ®Þch!", 2,
	 "Ta muèn t×m hiÓu viÖc kh¸c/wushuangmengjiang",
	  "KÕt thóc ®èi tho¹i/no")
end
...
--Change Song Jin Box bind state -  - 20120319
...
if CalcFreeItemCellCount() < 10 then
		Say("H·y cÊt bít vËt phÈm ®Ó ®¶m b¶o cã <color=yellow>10<color> « trèng råi h·y nhËn th­ëng..",0);
		return 1;
end
local setkimphong = 
		 {
		{szName="<color=yellow>B¶o R­¬ng V« §Þch Giíi ChØ", tbProp={6,1,4683,0,0,0}},
--		{szName="<color=yellow>B¶o R­¬ng Vinh DiÖu", tbProp={6,1,4662,0,0,0}},
		--		{szName="<color=yellow>Tinh ChuÈn Chi Ngoa", nQuality=1, tbProp={0, 513}, nExpiredTime = 10800},		
		}
	local szLog = format("PhÇn th­ëng Tèng Kim ChiÕn h¹ng %d", nRank)
	Msg2SubWorld("Chóc mõng cao thñ vâ l©m <color=yellow>"..GetName().."<color> <color=red>  ®· nhËn phÇn th­ëng tõ Tèng Kim ChiÕn H¹ng.  PhÇn th­ëng lµ <color=yellow>B¶o R­¬ng V« Song.")			
	tbAwardTemplet:GiveAwardByList(setkimphong[nRank], szLog)
end